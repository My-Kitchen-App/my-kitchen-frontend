          ...
          <Row xs={1} md={2} className="g-4">
            ...
            <Col>
              <ReactCardFlip isFlipped={this.state.showRae} flipDirection="vertical">
                ...
                <Card border="dark">
                  <Card.Text>
                    Hello, my name is Regan Hayes. I am a Software Developer from Virginia. I am prior Air Force and my time serving taught me the importance of team work and attention to details. I love problem solving and taking on new challenges. I am always looking for ways to improve myself. I have been interested in pursuing a career in technology since junior high but I discovered my passion for Software Engineering through an app called “mimo” that teaches you how to code through hands on learning. What I enjoy most about software engineering is the creation process: being able to build something from nothing. I am excited to be on this journey; learning new things and meeting new people.
                  </Card.Text>
                  <Button variant="outline-secondary" onClick={() => this.setState({ showRae: false })}>Click to see the Developer</Button>
                </Card>
              </ReactCardFlip>
            </Col>
          </Row>
            ...
            <Col>
              <ReactCardFlip isFlipped={this.state.showKevin} flipDirection="vertical">
                ...
                <Card border="dark">
                  ...
                  <Button variant="outline-secondary" onClick={() => this.setState({ showKevin: false })}>Click to see the Developer</Button>
                </Card>
              </ReactCardFlip>
            </Col>
            <Col>
              <ReactCardFlip isFlipped={this.state.showShane} flipDirection="vertical">
                ...
                <Card border="dark">
                  ...
                  <Button variant="outline-secondary" onClick={() => this.setState({ showShane: false })}>Click to see the Developer</Button>
                </Card>
              </ReactCardFlip>
            </Col>
